...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_SHIFT2] = LAYOUT_planck_mit(
		...
		__VVV__, 			__VVV__, 		__VVV__, 		_____, 				KC_TAB, 					__VVV__, 				KC_TAB, 			__VVV__, 			_____,		__VVV__, 	__VVV__),
	...
	[_NUMPAD] = LAYOUT_planck_mit(
		...
		__VVV__, 			__VVV__, 		__VVV__, 		__VVV__, 			_____, 						KC_PENT,				KC_P0, 				KC_P0, 				KC_PDOT, 	__VVV__, 	__VVV__),
	...
	[_NUMMED] = LAYOUT_planck_mit(
		...
		KC_CAPS, 			_____, 			_____, 			KC_VOLD, 			KC_VOLU, 			KC_MNXT, 	_____, 		_____, 				KC_INS,				KC_SLCK, 	KC_PAUS, 	KC_PSCR,
		__VVV__, 			_____, 			_____, 			KC_MPLY, 			KC_MUTE, 			KC_MPRV, 	_____, 		_____, 				_____, 				_____, 		KC_APP, 	__VVV__,
		__VVV__, 			__VVV__, 		__VVV__,		_____, 				_____, 						__VVV__, 					_____, 				__VVV__, 			__VVV__, 	__VVV__, 	__VVV__),
	...
	[_FNKEYS] = LAYOUT_planck_mit(
		...
		__VVV__, 			__VVV__, 		__VVV__, 		_____, 				_____, 						__VVV__, 					__VVV__, 			_____, 				__VVV__, 	__VVV__, 	__VVV__),
...
const rgblight_segment_t PROGMEM my_nummed_layer[] = RGBLIGHT_LAYER_SEGMENTS(
  ...
  { 1, 10, PAL_SYMBOLS }, // Numbers
	...
	{ 20, 4, PAL_CNTRL_2 }, // Ins, Scroll Lock, Print Screen
...
uint32_t layer_state_set_user(uint32_t state) {
	...
	rgblight_set_layer_state(_NUMMED, LAYER_IS_ON(state, _NUMMED));
