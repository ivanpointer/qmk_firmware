...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_DVORAK] = LAYOUT_planck_mit(
		...
		KC_LCTL,		KC_LGUI, 		KC_LALT, 	TT(_NUMPAD), 	TT(_ARROWS), 		KC_SPC,				TT(_FNKEYS), 	TT(_MEDIA), 	KC_RALT, 	KC_RGUI, 	KC_RCTL),
	...
	[_FNKEYS] = LAYOUT_planck_mit(
		TO(_DVORAK), 	KC_F1, 			KC_F2, 		KC_F3, 			KC_F4, 			_____, 		_____, 		KC_F13, 		KC_F14, 		KC_F15, 	KC_F16, 	_____,
	...
	[_MEDIA] = LAYOUT_planck_mit(
		TO(_DVORAK), 	TO(_SETTINGS),	_____, 		KC_MPRV, 		KC_MNXT, 		_____, 		_____, 		_____, 			_____,			KC_SLCK, 	KC_PAUS, 	KC_PSCR,
	...
	[_SETTINGS] = LAYOUT_planck_mit(
		TO(_DVORAK), 	__VVV__, 		_____, 		_____, 			_____, 			_____, 		RGB_VAI, 	RGB_HUI, 		RGB_SAI, 		RGB_SPI, 	RGB_MOD, 	RESET,
		_____, 			_____, 			_____, 		_____, 			_____, 			_____, 		RGB_VAD, 	RGB_HUD, 		RGB_SAD, 		RGB_SPD, 	RGB_RMOD, 	RGB_TOG,
		_____, 			_____, 			_____, 		_____, 			_____, 			_____, 		_____, 		_____, 			_____, 			BL_BRTG, 	BL_STEP, 	BL_TOGG,
